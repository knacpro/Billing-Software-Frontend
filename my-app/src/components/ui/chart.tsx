...
>(
  (
    ...
    // Use the first item's payload for label if available
    const tooltipLabel = React.useMemo(() => {
      ...
      const value =
        !labelKey && typeof item.payload?.name === "string"
          ? config[item.payload.name as keyof typeof config]?.label || item.payload.name
          : itemConfig?.label;
